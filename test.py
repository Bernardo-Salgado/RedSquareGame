...
###################################### THIS ONE KEEPS THE LAST SELECTED, FOREVER SELECTED^^^
######################### WHILE THIS ONE DESELECTS THE LAST SELECTED SQUARE WHEN U CLICK ANYWHERE ELSE
...
#             running = False
#         elif event.type == pygame.MOUSEBUTTONDOWN:  # Check for mouse click
#             # Reset selected square on new click
#             selected_square = None
...
#             # If red is not selected, check for the yellow square
#             if selected_square is None and yellow_square.rect.collidepoint(mouse_pos):
#                 selected_square = 'yellow'
...
#         for j in range(rows):
#             rect = pygame.Rect(playable_x + i * cell_width, playable_y + j * cell_height, cell_width, cell_height)
#             pygame.draw.rect(screen, BLUE, rect, 2)  # Drawing the grid lines
